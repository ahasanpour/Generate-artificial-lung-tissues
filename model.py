    ...
    def build(self, is_train=True):
        ...
        def G1(z, scope='Generator'):
            with tf.variable_scope(scope) as scope:
                ...
                g_4 = deconv2d(g_3, deconv_info[3], is_train, name='g_4_deconv')
                print(scope.name, g_4)
                g_5 = deconv2d(g_4, deconv_info[4], is_train, name='g_5_deconv', activation_fn='tanh')
        ...
        def D1(img, scope='Discriminator', reuse=True):
            with tf.variable_scope(scope, reuse=reuse) as scope:
                ...
                d_5 = slim.fully_connected(
                    tf.reshape(d_4, [self.batch_size, -1]), n+1, scope='d_4_fc', activation_fn=None)
